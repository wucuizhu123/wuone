<template>
	<el-row :gutter="20">
				...
				<el-col :span="8">
					<div class="littetop"><p class="comelitte">Consumer <span style="font-size:15px">({{valuew}})</span></p></div>
					<div id="myChart0" :style="{width: '100%', height: '15rem'}"  class="ko"></div>
				</el-col>
				<el-col :span="8">
					<div class="littetop"><p class="comelitte">Commercial <span style="font-size:15px">({{valuew}})</span></p></div>
					<div id="myChart1" :style="{width: '100%', height: '15rem'}"  class="ko"></div>
				</el-col>
				<el-col :span="8">
                   <div class="littetop"><p class="comelitte">SMB <span style="font-size:15px">({{valuew}})</span></p></div>
...
<script>
 ...
 endtime:function(newValue, oldValue){
	...
	fromParent(cha,char,chart,timeo,timep){
					...
					(this.startime=="")?timeo=timeo:timeo=this.startime;
				(this.endtime=="")?timep=timep:timep=this.endtime; 
				...
				this.$http.post(this.apiUrl + '/byBrandAndBySegement/botTable', {
					"startTime": timeo,
					"endTime": timep,
					"source": this.soce
				}).then(function(data) {
...
//					this.valuew = this.value;
					...
					myChart0.on('click', (params) => {
						console.log(params.name.length);
						 if(params.name.length==8){
							console.log(params.name.charAt(5));
                 if(params.name.charAt(5)=="1"){	 
										if(params.name.charAt(7)=="1"){	
											this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"04"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"04"
											console.log(this.lastime);console.log(this.firsttime);
										}else if(params.name.charAt(7)=="2"){
                        this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"05"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"05"
											console.log(this.lastime);console.log(this.firsttime);
										}else{
									    this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"06"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"06"
											console.log(this.lastime);console.log(this.firsttime);
								}
								}else if(params.name.charAt(5)=="2"){
                  if(params.name.charAt(7)=="1"){
												this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"07"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"07"
											console.log(this.lastime);console.log(this.firsttime);
										}else if(params.name.charAt(7)=="2"){
                       this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"08"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"08"
											console.log(this.lastime);console.log(this.firsttime);
										}else{
									      this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"09"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"09"
											console.log(this.lastime);console.log(this.firsttime);
								}
								}else if(params.name.charAt(5)=="3"){
                  if(params.name.charAt(7)=="1"){
												this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"10"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"10"
											console.log(this.lastime);console.log(this.firsttime);
										}else if(params.name.charAt(7)=="2"){
                       this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"11"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"11"
											console.log(this.lastime);console.log(this.firsttime);
										}else{
									      this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"12"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"12"
											console.log(this.lastime);console.log(this.firsttime);
								}
								}else{
									if(params.name.charAt(7)=="1"){
											this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"01"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"01"
											console.log(lastime);console.log(firsttime);
										}else if(params.name.charAt(7)=="2"){
                        this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"02"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"02"
											console.log(this.lastime);console.log(this.firsttime);
										}else{
									    this.lastime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"03"
											this.firsttime="20"+params.name.charAt(2)+params.name.charAt(3)+"-"+"03"
											console.log(this.lastime);console.log(this.firsttime);
								}
								}
                  ...
                  if(params.name.charAt(5)=="1"){	 										
						...
						this.typed="Consumer";
           if(params.seriesName=="NB"||params.seriesName=="DT"){
							this.threeBand=params.seriesName;
						}else{
							this.threeBand="";
						}
					// 	if(this.mou==0){
          ...
          query: {
           ...
           start:this.firsttime,
					...
					sessionStorage.setItem('testKey','Product');
			})
